...
const Forget = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        // Define the backend endpoint URL with the email parameter
        const url = `http://localhost:8800/auth/confirm?email=${email}`; // Update with your backend endpoint
        ...
        try {
            ...
            if (response.status === 200) {
                ...
                // Handle errors
                alert("Email not found. Please write the correct one.")
            }
        } catch (error) {
            // Handle exceptions
