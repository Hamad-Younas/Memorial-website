...
const MemoryWallModal = ({ modalVisible, setModalVisible }) => {
    ...
    const handleClick = async () => {
        ...
        try {
            ...
            const response = await axios.post(`http://localhost:8800/wall/add?userId=${user._id}`, data);
...
export default MemoryWallModal;